          ...
          <div className="flex w-full overflow-hidden rounded-xl shadow-2xl">
            <div className="hero bg-base-100">
              <div className="hero-content w-full max-w-none flex-col-reverse px-0 py-0 md:flex-row">
                <div className="relative left-0 my-10 h-[25rem] w-full md:my-20 md:w-1/2">
                  <Image
                    alt="banner"
                    src="/Dynamite.png"
                ...
                <div className="w-full px-10 pt-10 md:w-1/2 md:py-10">
                  <h1 className=" text-5xl font-bold">The order is canceled</h1>
                  <p className="py-6 text-lg">Please try again later.</p>
                </div>
              </div>
            </div>
          </div>
